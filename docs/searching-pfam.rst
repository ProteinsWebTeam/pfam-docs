...
All Pfam entries, integrated or unintegrated into IntePro entries, are displayed in the sequence viewer. They are grouped by entry types (family, domain, repeat, site). 
